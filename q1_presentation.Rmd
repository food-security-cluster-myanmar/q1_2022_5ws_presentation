...
fsc %>% 
  ...
  geom_col() +
  geom_text(aes(label = comma(beneficiaries)), size = 4, vjust = -0.5) +
...
---
class: center, middle
### States/regions by beneficiaries reached
...
fsc %>%
  ...
  geom_col() + 
  geom_text(aes(label = `%_of_hhd`), vjust = -0.4, size = 4) + 
  scale_fill_viridis_d(option = "mako", direction = -1) + 
  scale_y_continuous(labels = comma, breaks = seq(0, 80000, by = 10000)) + 
  theme(legend.position = "none", 
        axis.text.x = element_text(angle = 30, hjust = 0.8, vjust = 0.9, size = 7), 
        axis.text.y = element_text(size = 7)) +
...
---
class: center, middle
### Breakdown of food insecurity status
...
class: center, middle
background-image: url("oversubscribed_townships.png")
